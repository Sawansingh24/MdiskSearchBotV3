...
class Config(object):
    ...
    BOT_USERNAME = os.getenv("BOT_USERNAME", "Cinema")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "2091430700"))
#    OWNER_USERNAME = os.getenv("OWNER_USERNAME", "Sawan")
    BACKUP_CHANNEL = os.getenv("BACKUP_CHANNEL", "Cinemabackup")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001757189538")
    ...
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "cinemawinsbackup")
